  ...
  <div class="image-card">
    <el-card :body-style="{ padding: '0px' }" shadow="hover" class="art-custom-card">
      ...
      <div class="image-wrapper">
        <el-image :src="imageUrl" fit="cover" loading="lazy">
        ...
        <!-- 阅读时间标签 -->
        <div class="read-time" v-if="readTime"> {{ readTime }} 阅读 </div>
      </div>
      ...
      <div class="content">
        ...
        <div class="stats">
          ...
          <span class="comments" v-if="comments !== undefined">
