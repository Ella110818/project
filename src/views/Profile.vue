        ...
        <el-card class="card1">
          ...
          <div class="user-info">
            <div class="user-profile">
              <img src="@/assets/touxiang.jpg" class="user-image" />
              <div class="user-name">
                <h2>沉醉2</h2>
              </div>
            </div>
            <div class="user-details">
              <table class="user-table">
                <tr class="underlined-cell">
                  <td class="column1"><strong>工号:</strong></td>
                  <td class="column2">未知</td>
                </tr>
                <tr class="underlined-cell">
                  <td class="column1"><strong>学院:</strong></td>
                  <td class="column2">y/y</td>
                </tr>
                <tr class="underlined-cell">
                  <td class="column1"><strong>性别:</strong></td>
                  <td class="column2">添加居住地</td>
                </tr>
                <tr class="underlined-cell">
                  <td class="column1"><strong>手机号:</strong></td>
                  <td class="column2">请填写行业信息</td>
                </tr>
                <tr class="underlined-cell">
                  <td class="column1"><strong>个人介绍:</strong></td>
                  <td class="column2">添加职业经历</td>
                </tr>
                <tr class="underlined-cell">
                  <td class="column1"><strong>教育经历:</strong></td>
                  <td class="column2">添加教育经历</td>
                </tr>
              </table>
            </div>
          </div>
...
.user-image {
  ...
  z-index: 2;
  padding: 4px;
  background-color: rgb(180, 212, 171);
  box-sizing: border-box;
  border-radius: 7px;
}
